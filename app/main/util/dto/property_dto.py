...
class PropertyDto:
    ...
    property = api.model(
        "Property",
        {
            ...
            "purchase_date": fields.DateTime(
                required=True, description="purchase date"
            ),
            "monthly_rental_price": fields.Float(
                required=True, description="monthly rental price"
            ),
            "address": fields.Nested(
                AddressDto.address, required=True, description="address"
            ),
            "tenants": fields.List(
                fields.Nested(TenantDto.tenant), required=False, description="tenants"
            ),
            "created_date": fields.DateTime(required=False, description="date created"),
            "updated_date": fields.DateTime(
                required=False, description="date last updated"
            ),
            "property_pics": fields.List(
                fields.Nested(property_pictures), required=False, description="images"
            ),
        },
    )

    property_list = api.model(
        "Property",
        {
            "id": fields.String(required=True, description="id"),
            "portfolio_id": fields.String(required=True, description="portfolio id"),
    ...
    property_create = api.model(
        "Property",
        {
            ...
            "address": fields.Nested(
                AddressDto.address_create, required=True, description="address"
            ),
        },
    )
